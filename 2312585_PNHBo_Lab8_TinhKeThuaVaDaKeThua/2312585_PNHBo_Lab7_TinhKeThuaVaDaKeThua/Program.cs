...
namespace _2312585_PNHBo_Lab7_TinhKeThuaVaDaKeThua
{
            ...
            while (true)
            {
                ...
                switch (chon)
                {
                    ...
                    case ThucDon.DemSoLuongPhuongTienCar:
                        Console.WriteLine("Số lượng của phương tiện Car là : " + dspt.DemSoLuongTheoLoaiPhuongTien(LoaiPhuongTien.Car));
                        break;
                    case ThucDon.DemSoLuongPhuongTienMotorcycle:
                        Console.WriteLine("Số lượng của phương tiện Motorcycle : " + dspt.DemSoLuongTheoLoaiPhuongTien(LoaiPhuongTien.Motorcycle));
                        break;
                    case ThucDon.DemSoLuongPhuongTienCarAndMotorcycle:
                        Console.WriteLine("Số lượng của phương tiện Car và Motorcycle : " + dspt.DemSoLuongTheoLoaiPhuongTien(LoaiPhuongTien.CarAndMotorcycle));
                        break;
                    case ThucDon.DemSoLuongPhuongTienCarOrMotorcycle:
                        Console.WriteLine("Số lượng của phương tiện Car hoặc Motorcycle : " + dspt.DemSoLuongTheoLoaiPhuongTien(LoaiPhuongTien.CarOrMotorcycle));
                        break;
                    case ThucDon.DemSoLuongDemSoLuongTheoTen:
                        ...
                        Console.WriteLine("Số lượng là : " + dspt.DemSoLuongTheoTen(ten));
                        break;
                    case ThucDon.DemSoLuongTheoChoNgoi:
                        ...
                        Console.WriteLine("Số lượng là : " + dspt.DemSoLuongTheoChoNgoi(soChoNgoi));
                        break;
                    case ThucDon.DemSoLuongTheoTocDo:
                        ...
                        Console.WriteLine("Số lượng là : " + dspt.DemSoLuongTheoTocDo(tocDo));
                        break;
                    case ThucDon.DemSoLuongTheoTenVaSoChoNgoi:
                        ...
                        Console.WriteLine("Số lượng là : " + dspt.DemSoLuongTheoTenVaSoChoNgoi(ten1, soChoNgoi1));
                        break;
                    case ThucDon.DemSoLuongTheoTenVaTocDo:
                        ...
                        Console.WriteLine("Số lượng là : " + dspt.DemSoLuongTheoTenVaTocDo(ten2, tocDo2));
                        break;
                    case ThucDon.DemSoLuongTheoSoChoNgoiVaTocDo:
                        ...
                        Console.WriteLine("Số lượng là : " + dspt.DemSoLuongTheoSoChoNgoiVaTocDo(soChoNgoi3, tocDo3));
                        break;
                    case ThucDon.DemSoLuongTheoTenVaSoChoNgoivaTocDo:
                        ...
                        Console.WriteLine("Số lượng là : " + dspt.DemSoLuongTheoTenVaSoChoNgoivaTocDo(ten4, soChoNgoi4, tocDo4));
                        break;
                    case ThucDon.DemSoLuongTenDaiNhat:
                        Console.WriteLine("Đếm số lượng tên dài nhất là : " + dspt.DemSoLuongTenDaiNhat());
                        break;
                    case ThucDon.DemSoLuongTenNganNhat:
                        Console.WriteLine("Đếm số lượng tên ngắn nhất là : " + dspt.DemSoLuongTenNganNhat());
                        break;
                    case ThucDon.DemSoLuongChoNgoiLonNhat:
                        Console.WriteLine("Đếm số lượng chỗ ngồi lớn nhất là : " + dspt.DemSoLuongChoNgoiLonNhat());
                        break;
                    case ThucDon.DemSoLuongChoNgoiNhoNhat:
                        Console.WriteLine("Đếm số lượng chỗ ngồi nhỏ nhất là : " + dspt.DemSoLuongChoNgoiNhoNhat());
                        break;
                    case ThucDon.DemSoLuongTocDoLonNhat:
                        Console.WriteLine("Đếm số lượng tốc độ lớn nhất là : " + dspt.DemSoLuongTocDoLonNhat());
                        break;
                    case ThucDon.DemSoLuongTocDoNhoNhat:
                        Console.WriteLine("Đếm số lượng tốc độ nhỏ nhất là : " + dspt.DemSoLuongTocDoNhoNhat());
                        break;
                    case ThucDon.TimDSPhuongTienCar:
                        Console.WriteLine("Tìm danh sách phương tiện là Car !");
                        dspt.TimDSPhuongTien(LoaiPhuongTien.Car).Xuat();
                        break;
                    case ThucDon.TimDSPhuongTienMotorcycle:
                        Console.WriteLine("Tìm danh sách phương tiện là Motorcycle !");
                        dspt.TimDSPhuongTien(LoaiPhuongTien.Motorcycle).Xuat();
                        break;
                    case ThucDon.TimDSPhuongTienCarAndMotorcycle:
                        Console.WriteLine("Tìm danh sách phương tiện là Car và Motorcycle !");
                        dspt.TimDSPhuongTien(LoaiPhuongTien.CarAndMotorcycle).Xuat();
                        break;
                    case ThucDon.TimDSPhuongTienCarOrMotorcycle:
                        Console.WriteLine("Tìm danh sách phương tiện là Car hoặc Motorcycle !");
                        dspt.TimDSPhuongTien(LoaiPhuongTien.CarOrMotorcycle).Xuat();
                        break;
                    case ThucDon.TimDSDieuKienTen:
                        ...
                        dspt.TimDSDieuKien(LoaiDieuKien.Ten, ten5, 0, 0, null).Xuat();
                        break;
                    case ThucDon.TimDSDieuKienSoChoNgoi:
                        ...
                        dspt.TimDSDieuKien(LoaiDieuKien.SoChoNgoi, null, soChoNgoi5, 0, null).Xuat();
                        break;
                    case ThucDon.TimDSDieuKienTocDo:
                        ...
                        dspt.TimDSDieuKien(LoaiDieuKien.TocDo, null, 0, tocDo5, null).Xuat();
                        break;
                    case ThucDon.TimDSDieuKienTen_SoChoNgoi:
                        ...
                        dspt.TimDSDieuKien(LoaiDieuKien.TenvaSoChoNgoi, ten6, soChoNgoi6, 0, null).Xuat();
                        break;
                    case ThucDon.TimDSDieuKienTen_TocDo:
                        ...
                        dspt.TimDSDieuKien(LoaiDieuKien.TenvaTocDo, ten7, tocDo7, 0, null).Xuat();
                        break;
                    case ThucDon.TimDSDieuKienSoChoNgoi_TocDo:
                        ...
                        dspt.TimDSDieuKien(LoaiDieuKien.SoChoNgoivaTocDo, null, soChoNgoi8, tocDo8, null).Xuat();
                        break;
                    ...
                    case ThucDon.TimPhuongTienMotorcycle_MinTheoTocDo:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.Motorcycle, LoaiDieuKien.TocDo, LoaiSoSanh.NhoNhat).Xuat();
                        break;
                    case ThucDon.TimPhuongTienMotorcycle_MaxTheoTocDo:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.Motorcycle, LoaiDieuKien.TocDo, LoaiSoSanh.LonNhat).Xuat();
                        break;
                    case ThucDon.TimPhuongTienCarAndMotorcycle_MinTheoTen:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.CarAndMotorcycle, LoaiDieuKien.Ten, LoaiSoSanh.NganNhat).Xuat();
                        break;
                    case ThucDon.TimPhuongTienCarAndMotorcycle_MaxTheoTen:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.CarAndMotorcycle, LoaiDieuKien.Ten, LoaiSoSanh.DaiNhat).Xuat();
                        break;
                    case ThucDon.TimPhuongTienCarAndMotorcycle_MinTheoTocDo:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.CarAndMotorcycle, LoaiDieuKien.TocDo, LoaiSoSanh.NhoNhat).Xuat();
                        break;
                    case ThucDon.TimPhuongTienCarAndMotorcycle_MaxTheoTocDo:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.CarAndMotorcycle, LoaiDieuKien.TocDo, LoaiSoSanh.LonNhat).Xuat();
                        break;
                    case ThucDon.TimPhuongTienCarOrMotorcycle_MinTheoTen:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.CarOrMotorcycle, LoaiDieuKien.Ten, LoaiSoSanh.NganNhat).Xuat();
                        break;
                    case ThucDon.TimPhuongTienCarOrMotorcycle_MaxTheoTen:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.CarOrMotorcycle, LoaiDieuKien.Ten, LoaiSoSanh.DaiNhat).Xuat();
                        break;
                    case ThucDon.TimPhuongTienCarOrMotorcycle_MinTheoTocDo:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.CarOrMotorcycle, LoaiDieuKien.TocDo, LoaiSoSanh.NhoNhat).Xuat();
                        break;
                    case ThucDon.TimPhuongTienCarOrMotorcycle_MaxTheoTocDo:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.CarOrMotorcycle, LoaiDieuKien.TocDo, LoaiSoSanh.LonNhat).Xuat();
                        break;
                    case ThucDon.TimPhuongTienCarOrMotorcycle_MinTheoSoChoNgoi:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.CarOrMotorcycle, LoaiDieuKien.SoChoNgoi, LoaiSoSanh.NhoNhat).Xuat();
                        break;
                    case ThucDon.TimPhuongTienCarOrMotorcycle_MaxTheoSoChoNgoi:
                        ...
                        dspt.TimPhuongTienMin_MaxTheoDieuKien(LoaiPhuongTien.CarOrMotorcycle, LoaiDieuKien.SoChoNgoi, LoaiSoSanh.LonNhat).Xuat();
                        break;
                    ...
                    case ThucDon.TimPhuongTienCarTheoTen:
                        ...
                        dspt.TimLoaiPhuongTienVaLoaiDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.Ten, ten15, 0, 0).Xuat();
                        break;
                    case ThucDon.TimPhuongTienCarTheoSoChoNgoi:
                        ...
                        dspt.TimLoaiPhuongTienVaLoaiDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.SoChoNgoi, null, soChoNgoi15, 0).Xuat();
                    ...
                    case ThucDon.TimPhuongTienCarTheoTocDo:
                        ...
                        dspt.TimLoaiPhuongTienVaLoaiDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.TocDo, null, 0, tocDo15).Xuat();
                    ...
                    case ThucDon.TimPhuongTienCarTheoTen_SoChoNgoi:
                        ...
                        dspt.TimLoaiPhuongTienVaLoaiDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.TenvaSoChoNgoi, ten16, soChoNgoi12, 0).Xuat();
                    ...
                    case ThucDon.TimPhuongTienCarTheoTen_TocDo:
                        ...
                        dspt.TimLoaiPhuongTienVaLoaiDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.TenvaTocDo, ten17, 0, tocDo16).Xuat();
                    ...
                    case ThucDon.TimPhuongTienCarTheoSoChoNgoi_TocDo:
                        ...
                        dspt.TimLoaiPhuongTienVaLoaiDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.SoChoNgoivaTocDo, null, soChoNgoi17, tocDo18).Xuat();
                    ...
                    case ThucDon.XoaTheoDieuKienTen:
                        ...
                        dspt.XoaTheoLoaiDieuKien(LoaiDieuKien.Ten, ten10, 0, 0, null);
                        dspt.Xuat();
                        break;
                    case ThucDon.XoaTheoDieuKienSoChoNgoi:
                        ...
                        dspt.XoaTheoLoaiDieuKien(LoaiDieuKien.SoChoNgoi, null, soChoNgoi10, 0, null);
                        dspt.Xuat();
                        break;
                    case ThucDon.XoaTheoDieuKienTocDo:
                        ...
                        dspt.XoaTheoLoaiDieuKien(LoaiDieuKien.TocDo, null, 0, tocDo10, null);
                        dspt.Xuat();
                        break;
                    case ThucDon.XoaTheoDieuTen_SoChoNgoi:
                        ...
                        dspt.XoaTheoLoaiDieuKien(LoaiDieuKien.TenvaSoChoNgoi, ten11, soChoNgoi11, 0, null);
                        dspt.Xuat();
                        break;
                    case ThucDon.XoaTheoDieuKienTen_TocDo:
                        ...
                        dspt.XoaTheoLoaiDieuKien(LoaiDieuKien.TenvaTocDo, ten12, 0, tocdo12, null);
                        dspt.Xuat();
                        break;
                    case ThucDon.XoaTheoDieuKienSoChoNgoi_TocDo:
                        ...
                        dspt.XoaTheoLoaiDieuKien(LoaiDieuKien.SoChoNgoivaTocDo, null, soChoNgoi13, tocDo13, null);
                        dspt.Xuat();
                        break;
                    case ThucDon.XoaTheoDieuKienTen_SoChoNgoi_TocDo:
                        ...
                        dspt.XoaTheoLoaiDieuKien(LoaiDieuKien.TenvaSoChoNgoivaTocDo, ten14, soChoNgoi14, tocDo14, null);
                        dspt.Xuat();
                        break;
                    case ThucDon.SXTenTang_SoChoNgoiTang_TocDoTang:
                        Console.WriteLine("Sắp xếp : Chiều dài tên tăng, số chỗ ngồi tăng, tốc độ tăng ");
                        dspt.SapXepTheoLoaiDieuKien(LoaiDieuKien.TocDo, SapXep.Giam)
                    ...
                    case ThucDon.SXTenTang_SoChoNgoiGiam_TocDoTang:
                        ...
                        dspt.SapXepTheoLoaiDieuKien(LoaiDieuKien.TocDo, SapXep.Tang)
                    ...
                    case ThucDon.XoaTenDaiNhat:
                        ...
                        dspt.XoaTheoLoaiSoSanh(LoaiSoSanh.DaiNhat, LoaiDieuKien.Ten);
                        dspt.Xuat();
                        break;
                    case ThucDon.XoaTenNganNhat:
                        dspt.Xuat();
                        Console.WriteLine("Xóa tên ngắn nhất ");
                        dspt.XoaTheoLoaiSoSanh(LoaiSoSanh.NganNhat, LoaiDieuKien.Ten);
                        dspt.Xuat();
                        break;
                    case ThucDon.XoaSoChoNgoiLonNhat:
                        dspt.Xuat();
                        Console.WriteLine("Xóa số chỗ ngồi lớn nhất ");
                        dspt.XoaTheoLoaiSoSanh(LoaiSoSanh.LonNhat, LoaiDieuKien.SoChoNgoi);
                        dspt.Xuat();
                        break;
                    case ThucDon.XoaSoChoNgoiNhoNhat:
                        dspt.Xuat();
                        Console.WriteLine("Xóa số chỗ ngồi nhỏ nhất ");
                        dspt.XoaTheoLoaiSoSanh(LoaiSoSanh.NhoNhat, LoaiDieuKien.SoChoNgoi);
                        dspt.Xuat();
                        break;
                    case ThucDon.XoaSoTocDoLonNhat:
                        dspt.Xuat();
                        Console.WriteLine("Xóa số tốc độ lớn nhất");
                        dspt.XoaTheoLoaiSoSanh(LoaiSoSanh.LonNhat, LoaiDieuKien.TocDo);
                        dspt.Xuat();
                        break;
                    case ThucDon.XoaSoTocDoNhoNhat:
                        dspt.Xuat();
                        Console.WriteLine("Xóa số tốc độ nhỏ nhất ");
                        dspt.XoaTheoLoaiSoSanh(LoaiSoSanh.NhoNhat, LoaiDieuKien.TocDo);
                        dspt.Xuat();
                        break;
                    ...
                    case ThucDon.SapXepCarTangTheoTen:
                        ...
                        dspt.SapXepTheoLoaiPhuongTienVaDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.Ten, SapXep.Tang).Xuat();
                        break;
                    case ThucDon.SapXepCarGiamTheoTen:
                        Console.WriteLine("Sắp xếp danh sách Car giảm dần theo tên:");
                        dspt.SapXepTheoLoaiPhuongTienVaDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.Ten, SapXep.Giam).Xuat();
                        break;
                    case ThucDon.SapXepCarTangTheoSoChoNgoi:
                        Console.WriteLine("Sắp xếp danh sách Car tăng dần theo số chỗ ngồi:");
                        dspt.SapXepTheoLoaiPhuongTienVaDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.SoChoNgoi, SapXep.Tang).Xuat();
                        break;
                    case ThucDon.SapXepCarGiamTheoSoChoNgoi:
                        Console.WriteLine("Sắp xếp danh sách Car giảm dần theo số chỗ ngồi:");
                        dspt.SapXepTheoLoaiPhuongTienVaDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.SoChoNgoi, SapXep.Giam).Xuat();
                        break;
                    case ThucDon.SapXepCarTangTheoTocDo:
                        Console.WriteLine("Sắp xếp danh sách Car tăng dần theo tốc độ:");
                        dspt.SapXepTheoLoaiPhuongTienVaDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.TocDo, SapXep.Tang).Xuat();
                        break;
                    case ThucDon.SapXepCarGiamTheoTocDo:
                        Console.WriteLine("Sắp xếp danh sách Car giảm dần theo tốc độ:");
                        dspt.SapXepTheoLoaiPhuongTienVaDieuKien(LoaiPhuongTien.Car, LoaiDieuKien.TocDo, SapXep.Giam).Xuat();
                        break;
                    case ThucDon.SapXepTangMotorcycleTheoTen:
                        Console.WriteLine("Sắp xếp danh sách Motorcycle tăng dần theo tên:");
                        dspt.SapXepTheoLoaiPhuongTienVaDieuKien(LoaiPhuongTien.Motorcycle, LoaiDieuKien.Ten, SapXep.Tang).Xuat();
                        break;
                    case ThucDon.SapXepGiamMotorcycleTheoTen:
                        Console.WriteLine("Sắp xếp danh sách Motorcycle giảm dần theo tên:");
                        dspt.SapXepTheoLoaiPhuongTienVaDieuKien(LoaiPhuongTien.Motorcycle, LoaiDieuKien.Ten, SapXep.Giam).Xuat();
                        break;
                    case ThucDon.SapXepTangMotorcycleTheoTocDo:
                        Console.WriteLine("Sắp xếp danh sách Motorcycle tăng dần theo tốc độ:");
                        dspt.SapXepTheoLoaiPhuongTienVaDieuKien(LoaiPhuongTien.Motorcycle, LoaiDieuKien.TocDo, SapXep.Tang).Xuat();
                        break;
                    ...
                    case ThucDon.NhapFileDSKH:
                        dskh.DocFile(dspt);
                        break;
                    case ThucDon.XuatDSKH:
                        dskh.Xuat();
                        break;
                    case ThucDon.SapXepTangTheoDSKH:
                        dskh.SapTangDSKH();
                        dskh.Xuat();
                        break;
                    case ThucDon.SapXepGiamTheoDSKH:
                        dskh.SapGiamDSKH();
                        dskh.Xuat();
                        break;
                    case ThucDon.TimDSKHCar:
                        dskh.TimDSKHCar().Xuat();

                        break;
                    case ThucDon.TimDSKHMotorcycle:
                        dskh.TimDSKHMotorcycle().Xuat();
                    ...
                    case ThucDon.TimDSKHTheoCCCD:
                        dskh.Xuat();
                        Console.Write("Nhập CCCD khách hàng cần tìm : ");
                        string cccd = Console.ReadLine();
                        dskh.TimDSKHTheoCCCD(cccd).Xuat();

                        break;
                    case ThucDon.TimDSKHKhongCoPT:
                        Console.WriteLine("Danh sách khách hàng không có Phương Tiện :");
                        dskh.TimDSKHKoCoPT().Xuat();

                        break;
                    case ThucDon.TimDSKHSoHuuNhieuNhatTheoPTCar:
                        dskh.TimDSKHSoHuuNhieuNhatTheoPT(LoaiPhuongTien.Car).Xuat();
                        break;
                    case ThucDon.TimDSKHSoHuuNhieuNhatTheoPTMotorcycle:
                        dskh.TimDSKHSoHuuNhieuNhatTheoPT(LoaiPhuongTien.Motorcycle).Xuat();
                        break;
                    case ThucDon.TimDSKHSoHuuItNhatTheoPTCar:
                        dskh.TimDSKHSoHuuItNhatTheoPT(LoaiPhuongTien.Car).Xuat();
                        break;
                    case ThucDon.TimDSKHSoHuuItNhatTheoPTMotorcycle:
    ...
    public enum ThucDon
    {
        ...
        TimDSKHTheoCCCD,
        TimDSKHKhongCoPT,
        TimDSKHSoHuuNhieuNhatTheoPTCar,
        TimDSKHSoHuuNhieuNhatTheoPTMotorcycle,
        TimDSKHSoHuuItNhatTheoPTCar,
        TimDSKHSoHuuItNhatTheoPTMotorcycle,
